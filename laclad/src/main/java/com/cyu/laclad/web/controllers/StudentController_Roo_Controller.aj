...
import com.cyu.laclad.web.controllers.StudentController;
...
privileged aspect StudentController_Roo_Controller {
    ...
    void StudentController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("student_birthday_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
