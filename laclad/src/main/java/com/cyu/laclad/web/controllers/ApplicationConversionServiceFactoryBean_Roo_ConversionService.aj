...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Email, String> ApplicationConversionServiceFactoryBean.getEmailToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.cyu.laclad.domain.Email, java.lang.String>() {
    ...
    public Converter<Long, Email> ApplicationConversionServiceFactoryBean.getIdToEmailConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.cyu.laclad.domain.Email>() {
            public com.cyu.laclad.domain.Email convert(java.lang.Long id) {
    ...
    public Converter<String, Email> ApplicationConversionServiceFactoryBean.getStringToEmailConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.cyu.laclad.domain.Email>() {
            public com.cyu.laclad.domain.Email convert(String id) {
