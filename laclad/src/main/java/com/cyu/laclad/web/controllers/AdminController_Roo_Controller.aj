...
privileged aspect AdminController_Roo_Controller {
    ...
    void AdminController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("admin_birthday_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("admin_enrolddate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
